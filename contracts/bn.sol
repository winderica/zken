...
library BigNumber {
     ...
     * returns: instance r.
     */
    function u(bytes memory val) internal pure returns (instance memory r) {
    ...
    function modexp_and_mul(
        BigNumber.instance[2] memory lr,
        ...
        if (exp_is_neg) {
            lr[0] = BigNumber.modmul(lr[0], x, n);
        } else {
            lr[1] = BigNumber.modmul(lr[1], x, n);
        }
    }
